#' @title hue.RGB
#' @description Generates results for hue groups based on the RGB color matches
...
#' @return Hue groups, 3D RGB plot, color histogram
#' @examples hue.RGB(system.file("fungi.png", package = "PUPMCR"))
#' \dontrun{hue.RGB("fungi_image_format")}
...
#' @export
#Hue Groups
hue.RGB <- function(fungi, distance.method = "euclidean"){
