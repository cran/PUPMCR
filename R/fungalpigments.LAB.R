#' @title fungalpigments.LAB
#' @description Generates results for associated fungal pigments / class of compounds based on the CIELAB color matches
...
#' @return Fungal pigments, 3D LAB plot, color histogram
#' @examples fungalpigments.LAB(system.file("fungi.png", package = "PUPMCR"))
#' \dontrun{fungalpigments.LAB("fungi_image_format")}
...
#' @export
#Fungal Pigments / Class of Compounds
fungalpigments.LAB <- function(fungi, distance.method = "euclidean"){
