#' @title fungalpigments.RGB
#' @description Generates results for associated fungal pigments / class of compounds based on the RGB color matches
...
#' @return Fungal pigments, 3D RGB plot, color histogram
#' @examples fungalpigments.RGB(system.file("fungi.png", package = "PUPMCR"))
...
fungalpigments.RGB <- function(fungi, distance.method = "euclidean"){
